...
var Button = {
render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{staticClass:"btn",class:_vm.rootClass,on:{"click":function($event){$event.preventDefault();return _vm.clickHandler.apply(null, arguments)}}},[_vm._t("default")],2)},
staticRenderFns: [],
  name: "Button",
  props: {
    color: {
...
var SelectInput = {
render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"form-label"},[_vm._v("Select")]),_vm._v(" "),_c('select',_vm._b({staticClass:"form-select",class:{ 'is-invalid': _vm.invalid, 'is-valid': _vm.valid },on:{"input":_vm.onInput}},'select',_vm.$attrs,false),_vm._l((_vm.items),function(item,index){return _c('option',{key:index,domProps:{"value":index,"selected":_vm.isSelected(item)}},[_vm._v("\n      "+_vm._s(_vm.renderNameFn(item))+"\n    ")])}),0),_vm._v(" "),(_vm.message)?_c('div',{staticClass:"invalid-feedback"},[_vm._v("message")]):_vm._e()])},
staticRenderFns: [],
  name: "SelectInput",
  inheritAttrs: false,
  props: {
...
var FloatInputText = {
render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"form-floating"},[_c('input',_vm._b({staticClass:"form-control",class:{ 'is-invalid': _vm.invalid, 'is-valid': _vm.valid },attrs:{"type":"text"},domProps:{"value":_vm.value},on:{"input":_vm.onInput}},'input',_vm.$attrs,false)),_vm._v(" "),_c('label',{attrs:{"for":"floating-input"}},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),(_vm.message)?_c('div',{staticClass:"invalid-feedback"},[_vm._v("message")]):_vm._e()])},
staticRenderFns: [],
  name: "FloatInputText",
  inheritAttrs: false,
  props: {
...
var FloatInputEmail = {
render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"form-floating"},[_c('input',_vm._b({staticClass:"form-control",class:{ 'is-invalid': _vm.invalid, 'is-valid': _vm.valid },attrs:{"type":"email"},domProps:{"value":_vm.value},on:{"input":_vm.onInput}},'input',_vm.$attrs,false)),_vm._v(" "),_c('label',{attrs:{"for":"floating-input"}},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),(_vm.message)?_c('div',{staticClass:"invalid-feedback"},[_vm._v("message")]):_vm._e()])},
staticRenderFns: [],
...
render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"form-floating"},[_c('input',_vm._b({staticClass:"form-control",class:{ 'is-invalid': _vm.invalid, 'is-valid': _vm.valid },attrs:{"type":"password","autocomplete":"off"},domProps:{"value":_vm.value},on:{"input":_vm.onInput}},'input',_vm.$attrs,false)),_vm._v(" "),_c('label',{attrs:{"for":"floating-input"}},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),(_vm.message)?_c('div',{staticClass:"invalid-feedback"},[_vm._v("message")]):_vm._e()])},
staticRenderFns: [],
